...
public class operationTheatre_testcase extends AppTestBase
{
	...
	@Test(priority = 10, groups = {"sanity"}, description="On  the \"Booking OT Schedule | New Patient\" form's,\r\n"
			...
			+ "by using javaScript.")
	public void closeBookingOTScheduleNewPatientFormsByUsingJsExecutor() throws Exception {
		operationTheatre_PagesInstance = new operationTheatre_Pages(driver);
		locatorsFactoryInstance = new LocatorsFactory(driver);
	...
	public void validateBillingHandOverSectionsRemarksFieldAndHandOverButton() throws Exception {
		operationTheatre_PagesInstance = new operationTheatre_Pages(driver);
		locatorsFactoryInstance = new LocatorsFactory(driver);
		Map<String, String> expectedData = new FileOperations().readExcelPOI(expectedDataFilePath, "operationTheatreModule");


		Assert.assertTrue(operationTheatre_PagesInstance.validateBillingHandOverSectionsRemarksFieldAndHandOverButton(expectedData), "Unable to perform the scroll operation, please check manually");
	...
	public void verifyLocatorsValueOfELement() throws Exception {
		operationTheatre_PagesInstance = new operationTheatre_Pages(driver);
		locatorsFactoryInstance = new LocatorsFactory(driver);
	...
	public void verifyRadioAndDropDownButton() throws Exception {
		operationTheatre_PagesInstance = new operationTheatre_Pages(driver);
		locatorsFactoryInstance = new LocatorsFactory(driver);
		Map<String, String> expectedData = new FileOperations().readExcelPOI(expectedDataFilePath, "operationTheatreModule");
...
//		operationTheatre_PagesInstance = new operationTheatre_Pages(driver);
//		locatorsFactoryInstance = new LocatorsFactory(driver);
//		Assert.assertTrue(operationTheatre_PagesInstance.uploadImageInScannedImagesSection(System.getProperty("user.dir") + "\\testImage\\uploadImage.png"),"Not able to upload the image, please check manually");
